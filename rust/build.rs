...
fn generate_rust_code_from_toml(config: &Value) -> String {
    ...
    code.push_str("// IMPORTANT: This file is automatically generated and should not be committed to source control.\n\n");
    code.push_str("use std::collections::HashMap;\n\n");
    code.push_str("pub fn get_ticker_vectors_map() -> HashMap<&'static str, &'static str> {\n");
