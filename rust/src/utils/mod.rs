...
pub mod xhr_utils;
pub use xhr_utils::{xhr_fetch, xhr_fetch_and_cache};
...
pub use shared_network_cache::{get_shared_cache_future, insert_shared_cache_future, remove_shared_cache_entry};
