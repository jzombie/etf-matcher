...
pub struct ETFAggregateDetail {
    ...
    top_sector_market_value: f64,
    currency_code: String,
    top_pct_sector_id: Option<SectorId>,
    top_pct_industry_id: Option<IndustryId>,
    top_pct_sector_weight: f32,
    //
    avg_revenue_current: Option<f64>,
    avg_gross_profit_current: Option<f64>,
    avg_operating_income_current: Option<f64>,
    avg_net_income_current: Option<f64>,
    avg_revenue_1_year_ago: Option<f64>,
    avg_gross_profit_1_year_ago: Option<f64>,
    avg_operating_income_1_year_ago: Option<f64>,
    avg_net_income_1_year_ago: Option<f64>,
    avg_revenue_2_years_ago: Option<f64>,
    avg_gross_profit_2_years_ago: Option<f64>,
    avg_operating_income_2_years_ago: Option<f64>,
    avg_net_income_2_years_ago: Option<f64>,
    avg_revenue_3_years_ago: Option<f64>,
    avg_gross_profit_3_years_ago: Option<f64>,
    avg_operating_income_3_years_ago: Option<f64>,
    avg_net_income_3_years_ago: Option<f64>,
    avg_revenue_4_years_ago: Option<f64>,
    avg_gross_profit_4_years_ago: Option<f64>,
    avg_operating_income_4_years_ago: Option<f64>,
    avg_net_income_4_years_ago: Option<f64>,
    avg_total_assets_current: Option<f64>,
    avg_total_liabilities_current: Option<f64>,
    avg_total_stockholders_equity_current: Option<f64>,
    avg_total_assets_1_year_ago: Option<f64>,
    avg_total_liabilities_1_year_ago: Option<f64>,
    avg_total_stockholders_equity_1_year_ago: Option<f64>,
    avg_total_assets_2_years_ago: Option<f64>,
    avg_total_liabilities_2_years_ago: Option<f64>,
    avg_total_stockholders_equity_2_years_ago: Option<f64>,
    avg_total_assets_3_years_ago: Option<f64>,
    avg_total_liabilities_3_years_ago: Option<f64>,
    avg_total_stockholders_equity_3_years_ago: Option<f64>,
    avg_total_assets_4_years_ago: Option<f64>,
    avg_total_liabilities_4_years_ago: Option<f64>,
    avg_total_stockholders_equity_4_years_ago: Option<f64>,
    avg_operating_cash_flow_current: Option<f64>,
    avg_net_cash_provided_by_operating_activities_current: Option<f64>,
    avg_net_cash_used_for_investing_activities_current: Option<f64>,
    avg_net_cash_used_provided_by_financing_activities_current: Option<f64>,
    avg_operating_cash_flow_1_year_ago: Option<f64>,
    avg_net_cash_provided_by_operating_activities_1_year_ago: Option<f64>,
    avg_net_cash_used_for_investing_activities_1_year_ago: Option<f64>,
    avg_net_cash_used_provided_by_financing_activities_1_year_ago: Option<f64>,
    avg_operating_cash_flow_2_years_ago: Option<f64>,
    avg_net_cash_provided_by_operating_activities_2_years_ago: Option<f64>,
    avg_net_cash_used_for_investing_activities_2_years_ago: Option<f64>,
    avg_net_cash_used_provided_by_financing_activities_2_years_ago: Option<f64>,
    avg_operating_cash_flow_3_years_ago: Option<f64>,
    avg_net_cash_provided_by_operating_activities_3_years_ago: Option<f64>,
    avg_net_cash_used_for_investing_activities_3_years_ago: Option<f64>,
    avg_net_cash_used_provided_by_financing_activities_3_years_ago: Option<f64>,
    avg_operating_cash_flow_4_years_ago: Option<f64>,
    avg_net_cash_provided_by_operating_activities_4_years_ago: Option<f64>,
    avg_net_cash_used_for_investing_activities_4_years_ago: Option<f64>,
    avg_net_cash_used_provided_by_financing_activities_4_years_ago: Option<f64>,
}
